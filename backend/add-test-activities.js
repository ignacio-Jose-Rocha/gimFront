...
const SUPABASE_URL = 'https://wsntuugxdzynpslbrfdz.supabase.co';
const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6IndzbnR1dWd4ZHp5bnBzbGJyZmR6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDUzNjgxMDAsImV4cCI6MjA2MDk0NDEwMH0.MSD584rXn9x9LkkNk1ITmRJYhppkfPbXqjCjOA0kZOk';

const supabase = createClient(SUPABASE_URL, SUPABASE_ANON_KEY);

const addTestActivities = async () => {
  console.log('🔍 Agregando actividades de prueba a Supabase...\n');
